...
from mi.dataset.driver.flort_dj.dcl.driver import FlortDjDclDataSetDriver
from mi.dataset.parser.flort_dj_dcl import FlortDjDclParserDataParticle
...
DataSetTestCase.initialize(
    ...
    startup_config = {
        DataSourceConfigKey.RESOURCE_ID: 'flort_dj_dcl',
...
SAMPLE_STREAM = 'flort_dj_dcl_parsed'
