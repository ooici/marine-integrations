...
SAMPLE_STREAM = 'parad_k__stc_imodem_instrument'
...
class IntegrationTest(DataSetIntegrationTestCase):
    ...
    def test_get(self):
        ...
        self.assert_data(Parad_k_stc_imodemParserDataParticle, 'first.result.yml', count=1, timeout=10)

        self.clear_async_data()
        self.create_sample_data('second.DAT', "E0000002.DAT")
        self.assert_data(Parad_k_stc_imodemParserDataParticle, 'second.result.yml', count=4, timeout=10)

        self.clear_async_data()
        self.create_sample_data('E0000303.DAT', "E0000303.DAT")
        # start is the same particle here, just use the same results
        self.assert_data(Parad_k_stc_imodemParserDataParticle, count=32, timeout=10)
    ...
    def test_stop_resume(self):
        ...
        self.assert_data(Parad_k_stc_imodemParserDataParticle, 'partial_second.result.yml', count=2, timeout=10)
