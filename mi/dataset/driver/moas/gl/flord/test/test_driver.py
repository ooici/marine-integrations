...
class IntegrationTest(DataSetIntegrationTestCase):
    ...
    def test_get(self):
        ...
        self.assert_data(FlordRecoveredDataParticle,
                         'single_flord_record_recovered.mrg.result.yml',
                         count=1, timeout=10)
        ...
        self.create_sample_data_set_dir('multiple_glider_record.mrg',
                                        ...
                                        "unit_363_2013_245_7_6.mrg")
        self.assert_data(FlordRecoveredDataParticle,
                         'multiple_flord_record_recovered.mrg.result.yml',
                         count=4, timeout=10)
    ...
    def test_stop_resume(self):
        ...
        state = {
            ...
            'unit_363_2013_245_6_9.mrg': self.get_file_state(path_2, False, 9208)
            },
            DataTypeKey.FLORD_RECOVERED: {
            'unit_363_2013_245_6_8.mrg': self.get_file_state(path_3, True, 9217),
            'unit_363_2013_245_6_9.mrg': self.get_file_state(path_4, False, 9208)
            }
        }
        ...
        self.assert_data(FlordTelemeteredDataParticle, 'merged_flord_record.mrg.result.yml', count=3, timeout=10)

        # verify data is produced for recovered particle
        self.assert_data(FlordRecoveredDataParticle, 'merged_flord_record_recovered.mrg.result.yml', count=3, timeout=10)
    ...
    def test_stop_start_ingest(self):
        ...
        self.assert_data(FlordRecoveredDataParticle, 'single_flord_record_recovered.mrg.result.yml', count=1, timeout=10)
        ...
        self.assert_data(FlordRecoveredDataParticle, 'multiple_flord_record_recovered.mrg.result.yml', count=4, timeout=10)
...
class QualificationTest(DataSetQualificationTestCase):
    ...
    def test_publish_path(self):
        ...
        try:
            ...
            # Verify values
            self.assert_data_values(result, 'single_flord_record_recovered.mrg.result.yml')
        except Exception as e:
            log.error("Exception trapped: %s", e)
            self.fail("Sample timeout.")
    ...
    def test_publish_path_missing_particle_parameters(self):
        ...
        published out the agent
        """
        self.create_sample_data_set_dir('cp_379_2014_104_18_0-ONEROW.mrg', TELEMETERED_TEST_DIR, 'unit_363_2013_245_6_9.mrg')
        self.assert_initialize()
        ...
        # Again for the recovered particle
        self.create_sample_data_set_dir('cp_379_2014_104_18_0-ONEROW.mrg', RECOVERED_TEST_DIR, 'unit_363_2013_245_6_9.mrg')
        ...
        try:
            ...
            #self.assert_data_values(result, 'single_flord_record_recovered_expectingMissingInputData.mrg.result.yml')
        except Exception as e:
            log.error("Exception trapped: %s", e)
            self.fail("Sample timeout.")
    ...
    def test_stop_start(self):
        ...
        try:
            ...
            log.debug("got result 2 %s", result)
            self.assert_data_values(result, 'merged_flord_record_recovered.mrg.result.yml')
            self.assert_sample_queue_size(DataParticleType.FLORD_M_GLIDER_INSTRUMENT_RECOVERED, 0)
