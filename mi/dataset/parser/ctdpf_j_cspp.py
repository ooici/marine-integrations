...
class CtdpfJCsppParserDataParticle(DataParticle):
    """
    Class for parsing data from the ctdpf_j_cspp data set
    """
...
class CtdpfJCsppParser(BufferLoadingParser):
