...
from mi.dataset.parser.parad_j_cspp import ParadJCsppParser, StateKey
from mi.dataset.parser.parad_j_cspp import ParadJCsppParserDataParticle
...
class ParadJCsppParserUnitTestCase(ParserUnitTestCase):
	...
	self.config = {
	    DataSetDriverConfigKeys.PARTICLE_MODULE: 'mi.dataset.parser.parad_j_cspp',
            DataSetDriverConfigKeys.PARTICLE_CLASS: 'ParadJCsppParserDataParticle'
	    }
