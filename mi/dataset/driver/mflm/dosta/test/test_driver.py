    ...
    startup_config = {
        DataSourceConfigKey.HARVESTER: {
            ...
            DataSourceKey.DOSTA_ABCDJM_SIO_RECOVERED: {
                ...
                DataSetDriverConfigKeys.PATTERN: 'DOS15908.DAT',
                DataSetDriverConfigKeys.FREQUENCY: 1,
                DataSetDriverConfigKeys.FILE_MOD_WAIT_TIME: 2,
            },
        },
...
class IntegrationTest(DataSetIntegrationTestCase):
    ...
    def test_get_recovered(self):
        ...
        self.create_sample_data_set_dir("DOS15908_1st7_step2.DAT", RECOV_DIR, "DOS15908.DAT",
                                        copy_metadata=False)
        self.assert_data(DostadParserDataParticle, 'test_data_2r.txt.result.yml',
                         count=1)

        # now 'appends' the rest of the data and just check if we get the right number
        self.clear_async_data()
        self.create_sample_data_set_dir("DOS15908.DAT", RECOV_DIR, "DOS15908.DAT",
                                        copy_metadata=False)
        self.assert_data(DostadParserDataParticle, count=4)
