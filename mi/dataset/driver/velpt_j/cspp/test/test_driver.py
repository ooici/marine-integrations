...
from mi.dataset.driver.velpt_j.cspp.driver import VelptJCsppDataSetDriver
from mi.dataset.parser.velpt_j_cspp import VelptJCsppParserDataParticle
...
SAMPLE_STREAM = 'velpt_j_cspp_parsed'
