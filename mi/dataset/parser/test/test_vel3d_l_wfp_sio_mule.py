...
from mi.dataset.parser.vel3d_l_wfp import Vel3dLWfpParser, StateKey
from mi.dataset.parser.vel3d_l_wfp import Vel3dLWfpParserDataParticle
...
class Vel3dLWfpParserUnitTestCase(ParserUnitTestCase):
	...
	self.config = {
	    DataSetDriverConfigKeys.PARTICLE_MODULE: 'mi.dataset.parser.vel3d_l_wfp',
            DataSetDriverConfigKeys.PARTICLE_CLASS: 'Vel3dLWfpParserDataParticle'
	    }
