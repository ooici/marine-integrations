...
"""
@package mi.dataset.parser.optaa_dg_cspp
@file marine-integrations/mi/dataset/parser/optaa_dg_cspp.py
@author Joe Padula
@brief Parser for the optaa_dg_cspp dataset driver
Release notes:
...
class DataParticleType(BaseEnum):
    SAMPLE = 'optaa_dg_cspp_parsed'

class OptaaDgCsppParserDataParticleKey(BaseEnum):

class StateKey(BaseEnum):
    POSITION='position' # holds the file position

class OptaaDgCsppParserDataParticle(DataParticle):
    """
    Class for parsing data from the optaa_dg_cspp data set
    """
...
class OptaaDgCsppParser(BufferLoadingParser):
