...
from mi.dataset.driver.dosta_abcdjm.dcl.driver import DostaAbcdjmDclDataSetDriver
from mi.dataset.parser.dosta_abcdjm_dcl import DostaAbcdjmDclParserDataParticle
...
DataSetTestCase.initialize(
    ...
    startup_config = {
        DataSourceConfigKey.RESOURCE_ID: 'dosta_abcdjm_dcl',
...
SAMPLE_STREAM = 'dosta_abcdjm_dcl_parsed'
