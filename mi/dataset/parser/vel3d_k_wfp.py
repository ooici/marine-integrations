...
class DataParticleType(BaseEnum):
    SAMPLE = 'vel3d_k_wfp_parsed'

class Vel3dKWfpParserDataParticleKey(BaseEnum):

class StateKey(BaseEnum):
    POSITION='position' # holds the file position

class Vel3dKWfpParserDataParticle(DataParticle):
    """
    Class for parsing data from the vel3d_k_wfp data set
    """
