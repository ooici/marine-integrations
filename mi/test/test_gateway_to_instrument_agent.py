...
# bin/nosetests -s -v mi/test/test_instrument_agent.py:TestInstrumentAgent.test_go_active
# bin/nosetests -s -v mi/test/test_instrument_agent.py:TestInstrumentAgent.test_get_set
# bin/nosetests -s -v mi/test/test_instrument_agent.py:TestInstrumentAgent.test_poll
...
class TestInstrumentAgent(IonIntegrationTestCase):
 ...
 #           print tup
        ...
        self._ia_mod = 'mi.instrument_agent'
