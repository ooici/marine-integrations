...
SAMPLE_CZ_DATA = "Powering Down "

SAMPLE_BREAK_DATA = "[BREAK Wakeup A]" + NEWLINE +\
"WorkHorse Broadband ADCP Version 50.40" + NEWLINE +\
"Teledyne RD Instruments (c) 1996-2010" + NEWLINE +\
"All Rights Reserved." + NEWLINE +\
">"

SAMPLE_ERR_DATA = "ERR 002:  NUMERAL EXPECTED" + NEWLINE + ">"
...
class DriverUnitTest(InstrumentDriverUnitTestCase):
    ...
    def test_chunker(self):
        ...
        self.assert_chunker_sample(chunker, SAMPLE_CZ_DATA)
        self.assert_chunker_sample_with_noise(chunker, SAMPLE_CZ_DATA)
        self.assert_chunker_fragmented_sample(chunker, SAMPLE_CZ_DATA)
        self.assert_chunker_combined_sample(chunker, SAMPLE_CZ_DATA)

        """
        self.assert_chunker_sample(chunker, SAMPLE_BREAK_DATA)
        self.assert_chunker_sample_with_noise(chunker, SAMPLE_BREAK_DATA)
        self.assert_chunker_fragmented_sample(chunker, SAMPLE_BREAK_DATA)
        self.assert_chunker_combined_sample(chunker, SAMPLE_BREAK_DATA)
        """
 
        self.assert_chunker_sample(chunker, SAMPLE_ERR_DATA)
        self.assert_chunker_sample_with_noise(chunker, SAMPLE_ERR_DATA)
        self.assert_chunker_fragmented_sample(chunker, SAMPLE_ERR_DATA)
        self.assert_chunker_combined_sample(chunker, SAMPLE_ERR_DATA)
