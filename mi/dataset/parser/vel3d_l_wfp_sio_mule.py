...
class DataParticleType(BaseEnum):
    SAMPLE = 'vel3d_l_wfp_parsed'

class Vel3dLWfpParserDataParticleKey(BaseEnum):

class StateKey(BaseEnum):
    POSITION='position' # holds the file position

class Vel3dLWfpParserDataParticle(DataParticle):
    """
    Class for parsing data from the vel3d_l_wfp data set
    """
...
class Vel3dLWfpParser(BufferLoadingParser):
