...
class SpkirAbjCsppParserDataParticle(DataParticle):
    """
    Class for parsing data from the spkir_abj_cspp data set
    """
...
class SpkirAbjCsppParser(BufferLoadingParser):
