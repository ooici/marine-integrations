...
SAMPLE_RAW_DATA = raw_sample_1 + raw_sample_2 + raw_sample_3 + raw_sample_4
...
###############################################################################
class OPTAAMixin(DriverTestMixin):
    '''
    ...
    _sample_parameters = {
        ...
        OPTAA_SampleDataParticleKey.CHECKSUM : {'type': int, 'value': 0x0f29 },
        OPTAA_SampleDataParticleKey.C_REFERENCE_COUNTS : {'type': list, 'value': [1105, 1293, 1497, 1718, 1954, 2215, 2501, 2814, 3145, 33035, 7181, 3758, 9237, 52757, 6034, 6556, 7104, 7691, 8320, 8982, 9672, 10392, 11124, 11856, 12600, 13357, 14148, 14990, 15930, 55357, 46913, 29508, 8008, 54091, 18510, 35408, 38227, 28758, 7000, 37210, 54108, 6238, 5471, 52832, 18017, 32866, 26210, 60770, 6754, 63073, 32608, 46431, 39774, 18780, 50779, 1625, 5206, 58964, 30033, 44623, 52556, 63049, 17957, 17158, 16364, 15586, 14825, 14085, 13374, 12687, 12031, 11400, 10802, 10226, 9645, 9161, 8730, 8296, 7885, 7497, 7133, 6467, 254] },
        OPTAA_SampleDataParticleKey.A_REFERENCE_COUNTS : {'type': list, 'value': [867, 1030, 1212, 1408, 1623, 1860, 2123, 2411, 2684, 51471, 18061, 40976, 41949, 43624, 5434, 5929, 6461, 7030, 7636, 8271, 8934, 9608, 10292, 10977, 11675, 12401, 13176, 14001, 8783, 46421, 17242, 42079, 1380, 12649, 11886, 63603, 40311, 1659, 15743, 17795, 7558, 7817, 39564, 53902, 50577, 27539, 49044, 49813, 29846, 56726, 64150, 53141, 29588, 58770, 9360, 9614, 64908, 41353, 64390, 14211, 19839, 15483, 30719, 29362, 28137, 26947, 25749, 24590, 23459, 22347, 21273, 20236, 19239, 18287, 17378, 16495, 15603, 14931, 14233, 13554, 12913, 12326, 2] },
        OPTAA_SampleDataParticleKey.C_SIGNAL_COUNTS : {'type': list, 'value': [1108, 1321, 1561, 1822, 2110, 2428, 2780, 3171, 3593, 36876, 3675, 4114, 58808, 6667, 7303, 7982, 8702, 9470, 10298, 11175, 12094, 13053, 14038, 15029, 16034, 17058, 18125, 19260, 64073, 5454, 27475, 41048, 40029, 52322, 43622, 15979, 36207, 41586, 29558, 1145, 20092, 16000, 13698, 56196, 10118, 8840, 45705, 50569, 22410, 33161, 13705, 29832, 18054, 50052, 64898, 57216, 31101, 49530, 46455, 6515, 21103, 29291, 26439, 25319, 24195, 23080, 21984, 20914, 19884, 18890, 17935, 17020, 16144, 15303, 14452, 13738, 13100, 12465, 11857, 11285, 10747, 3187, 47109] },
        OPTAA_SampleDataParticleKey.A_SIGNAL_COUNTS : {'type': list, 'value': [767, 950, 1152, 1371, 1614, 1882, 2181, 2515, 2829, 39951, 4271, 16656, 6083, 5609, 6196, 6821, 7499, 8230, 9010, 9838, 10706, 11606, 12527, 13464, 14425, 15433, 16510, 17657, 51009, 53317, 56393, 47949, 42832, 22612, 53847, 2650, 6493, 55648, 23906, 42596, 43111, 4713, 44394, 62572, 56685, 23406, 26990, 65391, 9582, 57454, 11117, 3436, 43371, 62057, 61032, 34406, 55651, 55905, 26206, 47963, 51032, 37974, 21054, 20155, 19276, 18404, 17561, 16736, 15934, 15160, 14415, 13697, 13014, 12361, 11712, 11112, 10618, 10115, 9633, 9176, 8741, 254, 339] }
        }   
...
###############################################################################
@attr('UNIT', group='mi')
class DriverUnitTest(InstrumentDriverUnitTestCase,OPTAAMixin):
...
###############################################################################
@attr('INT', group='mi')
class DriverIntegrationTest(InstrumentDriverIntegrationTestCase,OPTAAMixin):
    def setUp(self):
