...
class ParadJCsppParserDataParticle(DataParticle):
    """
    Class for parsing data from the parad_j_cspp data set
    """
...
class ParadJCsppParser(BufferLoadingParser):
