...
"""
@package mi.dataset.parser.test.test_vel3d_l_wfp_sio_mule
@file marine-integrations/mi/dataset/parser/test/test_vel3d_l_wfp_sio_mule.py
@author Steve Myerson (Raytheon)
@brief Test code for a vel3d_l_wfp parser for telemetered data
"""
...
class Vel3dLWfpSioMuleParserUnitTestCase(ParserUnitTestCase):
    ...
    def test_get_many(self):
        ...
        """
        log.info("=================== START MANY ======================")
        log.info("Many length %d", len(TEL_RECORD_4))
    ...
    def test_long_stream(self):
        ...
        log.info("Long Stream length %d", len(TEL_RECORD_10))
    ...
    def test_mid_state_start(self):
        ...
        log.info("Mid State length %d", len(TEL_RECORD_2_3))
    ...
    def test_set_state(self):
        ...
        log.info("Set State length %d", len(TEL_RECORD_2_3))
        input_file = StringIO(TEL_RECORD_2_3)
        self.parser = self.create_parser(input_file, self.state)
