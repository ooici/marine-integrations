...
SIGNON_STATUS = \
        "NANO,2013/06/12 18:03:44,*APPLIED GEOMECHANICS Model MD900-T Firmware V5.2 SN-N8642 ID01" + NEWLINE
...
class NANOTestMixinSub(DriverTestMixin):
    ...
    _sample_parameters_01 = {
        NANODataParticleKey.TIME: {TYPE: float, VALUE: 3578801134.0, REQUIRED: True },
        NANODataParticleKey.X_TILT: {TYPE: float, VALUE: -0.0882, REQUIRED: True },
        NANODataParticleKey.Y_TILT: {TYPE: float, VALUE: -0.7524, REQUIRED: True },
        NANODataParticleKey.TEMP: {TYPE: float, VALUE: 28.45, REQUIRED: True },
        NANODataParticleKey.SN: {TYPE: unicode, VALUE: 'N8642', REQUIRED: True }
    }

    _sample_parameters_02 = {
        NANODataParticleKey.TIME: {TYPE: float, VALUE: 3578801136.0, REQUIRED: True },
        NANODataParticleKey.X_TILT: {TYPE: float, VALUE: -0.0885, REQUIRED: True },
        NANODataParticleKey.Y_TILT: {TYPE: float, VALUE: -0.7517, REQUIRED: True },
