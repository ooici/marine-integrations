...
class CtdmoParserUnitTestCase(ParserUnitTestCase):
	...
	self.assert_result(result, [[5354, 5544, 1, 0], [6970,7160,1,0], [7547,7737,1,0]],
			   [[0, 12], [336, 394], [467, 2010], [5354, 8000]],
			   self.timestamp4, self.particle_a)
	result = self.parser.get_records(1)
	self.assert_result(result, [[6970,7160,1,0], [7547,7737,1,0]],
			   [[0, 12], [336, 394], [467, 2010], [5544, 8000]],
			   self.timestamp4, self.particle_b)
	result = self.parser.get_records(1)
	self.assert_result(result, [[7547,7737,1,0]],
    ...
    def test_in_process_start(self):
        ...
        test starting a parser with a state in the middle of processing
        """
        new_state = {StateKey.IN_PROCESS_DATA:[[6970,7160,1,0], [7547,7737,1,0]],
