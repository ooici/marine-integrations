...
from mi.dataset.parser.ctdpf_j_cspp import CtdpfJCsppParser, StateKey
from mi.dataset.parser.ctdpf_j_cspp import CtdpfJCsppParserDataParticle
...
class CtdpfJCsppParserUnitTestCase(ParserUnitTestCase):
	...
	self.config = {
	    DataSetDriverConfigKeys.PARTICLE_MODULE: 'mi.dataset.parser.ctdpf_j_cspp',
            DataSetDriverConfigKeys.PARTICLE_CLASS: 'CtdpfJCsppParserDataParticle'
	    }
