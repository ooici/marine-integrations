...
$ bin/nosetests -sv mi/drivers/uw_bars/test/test_thread.py
...
test_simple (mi.drivers.uw_bars.test.test_thread.ThreadTest) ... :: _T created
^\

$ bin/python -m unittest mi.drivers.uw_bars.test.test_thread
test_simple (mi.drivers.uw_bars.test.test_bars_client.DriverTest) ...
...
$ bin/python  mi/drivers/uw_bars/test/test_thread.py
